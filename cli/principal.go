...
func (o *principalRegistryOptions) registerFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(&o.kubeContext, "context", "", "kubeconfig context to use (default: the cluster name)")
}

// context resolves o.kubeContext if set, otherwise o.clusterName: rask names
// a cluster's kubeconfig context exactly its cluster name.
