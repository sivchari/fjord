...
// every other package talks to the narrow Provider/Config surface defined
// here. When bumping the kind version introduces a breaking change, this
// package is the only place that needs to change.
package kind
